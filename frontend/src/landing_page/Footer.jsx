      ...
      <div className="container footer-container">
        <div className="row footer-top">
          <div className="col-lg-3 col-md-6 footer-brand">
            <img className="footer-logo" src="media/images/logo.svg" alt="Zerodha" />
        ...
        <div className="footer-disclaimer">
          <p>
            ...
            to securities broking please write to complaints@zerodha.com, for DP related
            to dp@zerodha.com. Please ensure you carefully read the Risk Disclosure
            Document as prescribed by SEBI | ICF
          </p>

          <p>
            Procedure to file a complaint on{" "}
            <a href="">SEBI SCORES</a>: Register on SCORES
            portal. Mandatory details for filing complaints on SCORES: Name, PAN, Address,
          ...
          <p>
            ...
            application form to authorize your bank to make payment in case of allotment.
            In case of non allotment the funds will remain in your bank account. As a
            business we don't give stock tips, and have not authorized anyone to trade on
            behalf of others. If you find anyone claiming to be part of Zerodha and
